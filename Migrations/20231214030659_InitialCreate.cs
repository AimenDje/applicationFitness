            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    IDExercice = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    NomExercice = table.Column<string>(type: "VARCHAR(200)", maxLength: 200, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Exercices_Objectif_ObjectifId",
                        column: x => x.ObjectifId,
                        principalTable: "Objectif",
                        principalColumn: "ObjectifId",
                        onDelete: ReferentialAction.Cascade);
                });
