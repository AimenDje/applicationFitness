    ...
    public partial class test : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    IdObjectif = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    nom = table.Column<string>(type: "VARCHAR(200)", maxLength: 200, nullable: false),
                    progression = table.Column<string>(type: "VARCHAR(200)", maxLength: 200, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    aliment = table.Column<string>(type: "VARCHAR(250)", maxLength: 250, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Exercices_Objectifs_ObjectifId",
                        column: x => x.ObjectifId,
                        principalTable: "Objectifs",
                        principalColumn: "IdObjectif",
                        onDelete: ReferentialAction.Cascade);
                });
